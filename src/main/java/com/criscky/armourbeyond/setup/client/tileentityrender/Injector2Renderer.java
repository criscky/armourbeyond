...
public class Injector2Renderer extends TileEntityRenderer<Injector2TileEntity> {
    public static final DirectionProperty FACING = BlockStateProperties.HORIZONTAL_FACING;
    final double y_base = 0.78d;
    private final Minecraft mc = Minecraft.getInstance();


    public Injector2Renderer(TileEntityRendererDispatcher rendererDispatcherIn) {
        super(rendererDispatcherIn);
    }

    @Override
    public void render(Injector2TileEntity pBlockEntity, float pPartialTicks, MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer, int pCombinedLight, int pCombinedOverlay) {
