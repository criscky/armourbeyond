...
public class Injector2 extends Block {
    ...
    public Injector2() {
        super(Properties.of(Material.STONE).strength(150.0F, 3600000.0F));
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new Injector2TileEntity();
    }
    ...
    private void interactWith(World world, BlockPos pos, PlayerEntity player) {
        TileEntity tileEntity = world.getBlockEntity(pos);
        if (tileEntity instanceof Injector2TileEntity && player instanceof ServerPlayerEntity) {
            Injector2TileEntity te = (Injector2TileEntity) tileEntity;
    ...
    public void animateTick(BlockState pState, World pLevel, BlockPos pPos, Random pRand) {
        if(pLevel.getBlockEntity(pPos) instanceof Injector2TileEntity){
            Injector2TileEntity tileEntity1 = (Injector2TileEntity) pLevel.getBlockEntity(pPos);
